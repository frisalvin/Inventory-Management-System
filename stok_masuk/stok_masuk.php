...
OR stok_masuk.kode_barang LIKE '%$cari%'
)";
}
...
<a href="export_masuk_excel.php" class="btn btn-info btn-sm">Export Excel</a>
<a href="export_masuk_pdf.php" class="btn btn-warning btn-sm">Export PDF</a>
<a href="proses_masuk.php?hapus_semua=1"
    class="btn btn-danger btn-sm"
    onclick="return confirm('Apakah yakin ingin menghapus semua data stok masuk?')">
    Hapus Semua Data
</a>

<button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#modalMasuk">
Tambah Stok Masuk
</button>
...
<a href="proses_masuk.php?hapus=<?= $d['id']?>" class="btn btn-danger btn-sm">🗑</a>
...
$selected = ($b2['kode_barang']==$d['kode_barang']) ? "selected" : "";
echo "<option $selected value='$b2[kode_barang]'>
...
<input name="supplier" value="<?= $d['supplier']?>" class="form-control mb-2" placeholder="Supplier">
...
<input name="supplier" class="form-control mb-2" placeholder="Supplier">
